...
write_checkpoint -force -noxdef Pong_TopLevel.dcp

catch { report_utilization -file Pong_TopLevel_utilization_synth.rpt -pb Pong_TopLevel_utilization_synth.pb }
